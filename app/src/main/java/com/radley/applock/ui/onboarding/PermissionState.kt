...
data class AppLockPermissionStatus(
 ...
 */
@Composable
fun rememberPermissionStatus(): State<AppLockPermissionStatus> {
...
private fun read(context: Context) = AppLockPermissionStatus(
    accessibility = AppLockPermissions.isAccessibilityEnabled(context),
    overlay = AppLockPermissions.canDrawOverlays(context),
    usageAccess = AppLockPermissions.hasUsageAccess(context),
    notifications = AppLockPermissions.hasNotificationPermission(context),
    camera = AppLockPermissions.hasCameraPermission(context),
    unrestrictedBattery = AppLockPermissions.isIgnoringBatteryOptimizations(context),
)
