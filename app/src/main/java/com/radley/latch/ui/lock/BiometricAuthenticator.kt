 ...
 * asked for BIOMETRIC_STRONG, so requesting STRONG here would silently remove face unlock —
 * the thing this app was asked to support — with no error and no way for the user to tell why.
 *
